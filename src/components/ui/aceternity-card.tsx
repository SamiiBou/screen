    ...
    <div className="p-8 overflow-hidden h-full relative flex items-center justify-center">
      <div className="flex flex-row shrink-0 justify-center items-center gap-2">
        ...
        <Container className="h-12 w-12 circle-2">
          <GoCopilot className="h-6 w-6 text-[#1a1a1a]" />
        </Container>
        <Container className="circle-3">
          <OpenAILogo className="h-8 w-8 text-[#1a1a1a]" />
        </Container>
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "max-w-sm w-full mx-auto p-8 rounded-2xl group transition-all duration-300 hover:scale-[1.02] hover:shadow-xl",
        className
      )}
      style={{
...
export const CardTitle = ({
  ...
  return (
    <h3
      className={cn(
        "text-lg font-semibold py-2 leading-tight",
        className
      )}
      style={{
...
export const CardDescription = ({
  ...
  return (
    <p
      className={cn(
        "text-sm font-normal max-w-sm leading-relaxed",
        className
      )}
      style={{
...
export const CardSkeletonContainer = ({
  ...
  return (
    <div
      className={cn(
        "h-[15rem] md:h-[20rem] rounded-xl z-40 mb-4",
        className,
        showGradient &&
          "[mask-image:radial-gradient(50%_50%_at_50%_50%,white_0%,transparent_100%)]"
      )}
      style={{
        backgroundColor: showGradient ? '#f8fafc !important' : 'transparent !important',
      }}
    >
      {children}
    </div>
...
const Container = ({
  ...
  return (
    <div
      className={cn(
        "h-16 w-16 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110",
        className
      )}
      style={{
        backgroundColor: '#ffffff !important',
